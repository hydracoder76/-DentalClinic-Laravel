<footer class="bg-gray-800">
	<ul class="container mx-auto flex flex-col md:flex-row pb-16 pt-8">
		<li class="w-full md:w-1/4 my-4 md:my-0 flex justify-center items-center text-white">
			<a class="hover:text-blue-500" href="#">
				<i class="fas fa-tooth fa-3x mr-2"></i>
				<span class="text-xl">Dental Care</span>
			</a>
		</li>
		<li class="w-full md:w-1/4 my-4 md:my-0 flex flex-col items-center text-white px-8 text-center">
			<h3 class="text-xl border-b-2 border-dashed border-white w-full mb-4 py-1">We Are Open On:</h1>
			<p>Monday - Friday: <span class="ml-2">9am - 5pm</span></p>
			<p>Saturday: <span class="ml-2">9am - 1pm</span></p>
			<p class="text-red-600">Sunday: <span class="ml-2">Closed</span></p>
		</li>
		<li class="w-full md:w-1/4 my-4 md:my-0 flex flex-col items-center text-white px-8 text-center">
			<h3 class="text-xl border-b-2 border-dashed border-white w-full mb-4 py-1">Our location</h3>
			<p>Krunska 77</p>
			<p>Belgrade, Serbia</p>
		</li>
		<li class="w-full md:w-1/4 my-4 md:my-0 flex flex-col items-center text-white px-8 text-center">
			<h3 class="text-xl border-b-2 border-dashed border-white w-full mb-4 py-1">Get In Touch</h3>
			<p><i class="fas fa-envelope mr-2"></i> contact@example.com</p>
			<p><i class="fas fa-phone-alt mr-2"></i> 011 4159211</p>
